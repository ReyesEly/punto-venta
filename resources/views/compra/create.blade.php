                            ...
                            <div class="col-12 mb-4">
                                <select name="producto_id" id="producto_id" class="form-control selectpicker"
                                    ...
                                    @foreach ($productos as $item)
                                        <option value="{{ $item->id }}-{{ $item->precio_venta }}">
...
@push('js')
    ...
    <script>
        ...
        function mostrarValores() {
            ...
            let precioVentaActual = dataProducto[1];
            $('#precio_venta').val(precioVentaActual);
            //alert('Precio de venta actual: ' + precioVentaActual);
        }
        ...
        function agregarProducto() {
            ...
            let precioVentaActual = parseFloat(dataProducto[1]); // Convertir a número
            ...
            console.log('Precio de venta actual:', precioVentaActual);
            console.log('Precio de venta ingresado:', precioVenta);
